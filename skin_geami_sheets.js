...
// Filename: Ranpak_O2VR_Skin_geami_sheets.ggsk
// Generated Thu Jul 22 09:50:32 2021
...
function object2vrSkin(player,base) {
	...
	this.preloadImages=function() {
		...
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_cat_geami__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_cat_geami__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_cat_wrappak__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_cat_wrappak__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_cat_padpak__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_cat_padpak__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_cat_fillpak__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_cat_fillpak__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_ms_cabinet__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_ms_cabinet__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_hv_under_table__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_hv_under_table__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_mx_die_cut_only__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_mx_die_cut_only__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_mx_3d__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_mx_3d__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_hv__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_hv__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_standard__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_standard__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_die_cut_only__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_die_cut_only__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_wrappak_protector__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_wrappak_protector__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_padpak_lc__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_padpak_lc__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_padpak_jr__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_padpak_jr__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_padpak_guardian__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_padpak_guardian__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_padpak_cc__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_padpak_cc__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_go__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_go__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_ttc__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_ttc__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_tt__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_tt__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_trident__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_trident__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_m__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak_m__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_fillpak__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_closed__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_closed__a.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_open__o.png';
		preLoadImg.src=basePath + 'geami_sheets_GUI/button_open__a.png';
	}
	...
	this.addSkin=function() {
		...
		this._info__img.setAttribute('src',basePath + 'geami_sheets_GUI/info.png');
		...
		this._logo_01__img.setAttribute('src',basePath + 'geami_sheets_GUI/logo_01.png');
		...
		this._button_cat_geami__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_cat_geami.png');
		...
		this._button_cat_geami.onmouseover=function () {
			me._button_cat_geami__img.src=basePath + 'geami_sheets_GUI/button_cat_geami__o.png';
			me._button_cat_geami.ggIsOver=true;
		}
		this._button_cat_geami.onmouseout=function () {
			me._button_cat_geami__img.src=basePath + 'geami_sheets_GUI/button_cat_geami.png';
			me._button_cat_geami.ggIsOver=false;
		}
		this._button_cat_geami.onmousedown=function () {
			me._button_cat_geami__img.src=basePath + 'geami_sheets_GUI/button_cat_geami__a.png';
		}
		...
		this._img_cat_geami__img.setAttribute('src',basePath + 'geami_sheets_GUI/img_cat_geami.png');
		...
		this._button_cat_wrappak__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_cat_wrappak.png');
		...
		this._button_cat_wrappak.onmouseover=function () {
			me._button_cat_wrappak__img.src=basePath + 'geami_sheets_GUI/button_cat_wrappak__o.png';
			me._button_cat_wrappak.ggIsOver=true;
		}
		this._button_cat_wrappak.onmouseout=function () {
			me._button_cat_wrappak__img.src=basePath + 'geami_sheets_GUI/button_cat_wrappak.png';
			me._button_cat_wrappak.ggIsOver=false;
		}
		this._button_cat_wrappak.onmousedown=function () {
			me._button_cat_wrappak__img.src=basePath + 'geami_sheets_GUI/button_cat_wrappak__a.png';
		}
		...
		this._img_cat_wrappak__img.setAttribute('src',basePath + 'geami_sheets_GUI/img_cat_wrappak.png');
		...
		this._button_cat_padpak__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_cat_padpak.png');
		...
		this._button_cat_padpak.onmouseover=function () {
			me._button_cat_padpak__img.src=basePath + 'geami_sheets_GUI/button_cat_padpak__o.png';
			me._button_cat_padpak.ggIsOver=true;
		}
		this._button_cat_padpak.onmouseout=function () {
			me._button_cat_padpak__img.src=basePath + 'geami_sheets_GUI/button_cat_padpak.png';
			me._button_cat_padpak.ggIsOver=false;
		}
		this._button_cat_padpak.onmousedown=function () {
			me._button_cat_padpak__img.src=basePath + 'geami_sheets_GUI/button_cat_padpak__a.png';
		}
		...
		this._img_cat_padpak__img.setAttribute('src',basePath + 'geami_sheets_GUI/img_cat_padpak.png');
		...
		this._button_cat_fillpak__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_cat_fillpak.png');
		...
		this._button_cat_fillpak.onmouseover=function () {
			me._button_cat_fillpak__img.src=basePath + 'geami_sheets_GUI/button_cat_fillpak__o.png';
			me._button_cat_fillpak.ggIsOver=true;
		}
		this._button_cat_fillpak.onmouseout=function () {
			me._button_cat_fillpak__img.src=basePath + 'geami_sheets_GUI/button_cat_fillpak.png';
			me._button_cat_fillpak.ggIsOver=false;
		}
		this._button_cat_fillpak.onmousedown=function () {
			me._button_cat_fillpak__img.src=basePath + 'geami_sheets_GUI/button_cat_fillpak__a.png';
		}
		...
		this._img_cat_fillpak__img.setAttribute('src',basePath + 'geami_sheets_GUI/img_cat_fillpak.png');
		...
		this._button_geami_ms_cabinet__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_geami_ms_cabinet.png');
		...
		this._button_geami_ms_cabinet.onmouseover=function () {
			me._button_geami_ms_cabinet__img.src=basePath + 'geami_sheets_GUI/button_geami_ms_cabinet__o.png';
			me._button_geami_ms_cabinet.ggIsOver=true;
		}
		this._button_geami_ms_cabinet.onmouseout=function () {
			me._button_geami_ms_cabinet__img.src=basePath + 'geami_sheets_GUI/button_geami_ms_cabinet.png';
			me._button_geami_ms_cabinet.ggIsOver=false;
		}
		this._button_geami_ms_cabinet.onmousedown=function () {
			me._button_geami_ms_cabinet__img.src=basePath + 'geami_sheets_GUI/button_geami_ms_cabinet__a.png';
		}
		...
		this._button_geami_hv_under_table__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_geami_hv_under_table.png');
		...
		this._button_geami_hv_under_table.onmouseover=function () {
			me._button_geami_hv_under_table__img.src=basePath + 'geami_sheets_GUI/button_geami_hv_under_table__o.png';
			me._button_geami_hv_under_table.ggIsOver=true;
		}
		this._button_geami_hv_under_table.onmouseout=function () {
			me._button_geami_hv_under_table__img.src=basePath + 'geami_sheets_GUI/button_geami_hv_under_table.png';
			me._button_geami_hv_under_table.ggIsOver=false;
		}
		this._button_geami_hv_under_table.onmousedown=function () {
			me._button_geami_hv_under_table__img.src=basePath + 'geami_sheets_GUI/button_geami_hv_under_table__a.png';
		}
		...
		this._button_geami_sheets__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_geami_sheets.png');
		...
		this._button_geami_mx_die_cut_only__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_geami_mx_die_cut_only.png');
		...
		this._button_geami_mx_die_cut_only.onmouseover=function () {
			me._button_geami_mx_die_cut_only__img.src=basePath + 'geami_sheets_GUI/button_geami_mx_die_cut_only__o.png';
			me._button_geami_mx_die_cut_only.ggIsOver=true;
		}
		this._button_geami_mx_die_cut_only.onmouseout=function () {
			me._button_geami_mx_die_cut_only__img.src=basePath + 'geami_sheets_GUI/button_geami_mx_die_cut_only.png';
			me._button_geami_mx_die_cut_only.ggIsOver=false;
		}
		this._button_geami_mx_die_cut_only.onmousedown=function () {
			me._button_geami_mx_die_cut_only__img.src=basePath + 'geami_sheets_GUI/button_geami_mx_die_cut_only__a.png';
		}
		...
		this._button_geami_mx_3d__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_geami_mx_3d.png');
		...
		this._button_geami_mx_3d.onmouseover=function () {
			me._button_geami_mx_3d__img.src=basePath + 'geami_sheets_GUI/button_geami_mx_3d__o.png';
			me._button_geami_mx_3d.ggIsOver=true;
		}
		this._button_geami_mx_3d.onmouseout=function () {
			me._button_geami_mx_3d__img.src=basePath + 'geami_sheets_GUI/button_geami_mx_3d.png';
			me._button_geami_mx_3d.ggIsOver=false;
		}
		this._button_geami_mx_3d.onmousedown=function () {
			me._button_geami_mx_3d__img.src=basePath + 'geami_sheets_GUI/button_geami_mx_3d__a.png';
		}
		...
		this._button_geami_hv__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_geami_hv.png');
		...
		this._button_geami_hv.onclick=function () {
			me.player.openUrl("Ranpak_geami_hv.html","_self");
		}
		this._button_geami_hv.onmouseover=function () {
			me._button_geami_hv__img.src=basePath + 'geami_sheets_GUI/button_geami_hv__o.png';
			me._button_geami_hv.ggIsOver=true;
		}
		this._button_geami_hv.onmouseout=function () {
			me._button_geami_hv__img.src=basePath + 'geami_sheets_GUI/button_geami_hv.png';
			me._button_geami_hv.ggIsOver=false;
		}
		this._button_geami_hv.onmousedown=function () {
			me._button_geami_hv__img.src=basePath + 'geami_sheets_GUI/button_geami_hv__a.png';
		}
		this._button_geami_hv.onmouseup=function () {
			if (me._button_geami_hv.ggIsOver) {
				me._button_geami_hv__img.src=basePath + 'geami_sheets_GUI/button_geami_hv__o.png';
			} else {
				me._button_geami_hv__img.src=basePath + 'geami_sheets_GUI/button_geami_hv.png';
			}
		...
		this._button_geami_exbox_mini_standard__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_geami_exbox_mini_standard.png');
		...
		this._button_geami_exbox_mini_standard.onmouseover=function () {
			me._button_geami_exbox_mini_standard__img.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_standard__o.png';
			me._button_geami_exbox_mini_standard.ggIsOver=true;
		}
		this._button_geami_exbox_mini_standard.onmouseout=function () {
			me._button_geami_exbox_mini_standard__img.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_standard.png';
			me._button_geami_exbox_mini_standard.ggIsOver=false;
		}
		this._button_geami_exbox_mini_standard.onmousedown=function () {
			me._button_geami_exbox_mini_standard__img.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_standard__a.png';
		}
		...
		this._button_geami_exbox_mini_die_cut_only__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_geami_exbox_mini_die_cut_only.png');
		...
		this._button_geami_exbox_mini_die_cut_only.onmouseover=function () {
			me._button_geami_exbox_mini_die_cut_only__img.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_die_cut_only__o.png';
			me._button_geami_exbox_mini_die_cut_only.ggIsOver=true;
		}
		this._button_geami_exbox_mini_die_cut_only.onmouseout=function () {
			me._button_geami_exbox_mini_die_cut_only__img.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_die_cut_only.png';
			me._button_geami_exbox_mini_die_cut_only.ggIsOver=false;
		}
		this._button_geami_exbox_mini_die_cut_only.onmousedown=function () {
			me._button_geami_exbox_mini_die_cut_only__img.src=basePath + 'geami_sheets_GUI/button_geami_exbox_mini_die_cut_only__a.png';
		}
		...
		this._button_wrappak_protector__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_wrappak_protector.png');
		...
		this._button_wrappak_protector.onmouseover=function () {
			me._button_wrappak_protector__img.src=basePath + 'geami_sheets_GUI/button_wrappak_protector__o.png';
			me._button_wrappak_protector.ggIsOver=true;
		}
		this._button_wrappak_protector.onmouseout=function () {
			me._button_wrappak_protector__img.src=basePath + 'geami_sheets_GUI/button_wrappak_protector.png';
			me._button_wrappak_protector.ggIsOver=false;
		}
		this._button_wrappak_protector.onmousedown=function () {
			me._button_wrappak_protector__img.src=basePath + 'geami_sheets_GUI/button_wrappak_protector__a.png';
		}
		...
		this._button_padpak_lc__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_padpak_lc.png');
		...
		this._button_padpak_lc.onmouseover=function () {
			me._button_padpak_lc__img.src=basePath + 'geami_sheets_GUI/button_padpak_lc__o.png';
			me._button_padpak_lc.ggIsOver=true;
		}
		this._button_padpak_lc.onmouseout=function () {
			me._button_padpak_lc__img.src=basePath + 'geami_sheets_GUI/button_padpak_lc.png';
			me._button_padpak_lc.ggIsOver=false;
		}
		this._button_padpak_lc.onmousedown=function () {
			me._button_padpak_lc__img.src=basePath + 'geami_sheets_GUI/button_padpak_lc__a.png';
		}
		...
		this._button_padpak_jr__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_padpak_jr.png');
		...
		this._button_padpak_jr.onmouseover=function () {
			me._button_padpak_jr__img.src=basePath + 'geami_sheets_GUI/button_padpak_jr__o.png';
			me._button_padpak_jr.ggIsOver=true;
		}
		this._button_padpak_jr.onmouseout=function () {
			me._button_padpak_jr__img.src=basePath + 'geami_sheets_GUI/button_padpak_jr.png';
			me._button_padpak_jr.ggIsOver=false;
		}
		this._button_padpak_jr.onmousedown=function () {
			me._button_padpak_jr__img.src=basePath + 'geami_sheets_GUI/button_padpak_jr__a.png';
		}
		...
		this._button_padpak_guardian__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_padpak_guardian.png');
		...
		this._button_padpak_guardian.onmouseover=function () {
			me._button_padpak_guardian__img.src=basePath + 'geami_sheets_GUI/button_padpak_guardian__o.png';
			me._button_padpak_guardian.ggIsOver=true;
		}
		this._button_padpak_guardian.onmouseout=function () {
			me._button_padpak_guardian__img.src=basePath + 'geami_sheets_GUI/button_padpak_guardian.png';
			me._button_padpak_guardian.ggIsOver=false;
		}
		this._button_padpak_guardian.onmousedown=function () {
			me._button_padpak_guardian__img.src=basePath + 'geami_sheets_GUI/button_padpak_guardian__a.png';
		}
		...
		this._button_padpak_cc__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_padpak_cc.png');
		...
		this._button_padpak_cc.onmouseover=function () {
			me._button_padpak_cc__img.src=basePath + 'geami_sheets_GUI/button_padpak_cc__o.png';
			me._button_padpak_cc.ggIsOver=true;
		}
		this._button_padpak_cc.onmouseout=function () {
			me._button_padpak_cc__img.src=basePath + 'geami_sheets_GUI/button_padpak_cc.png';
			me._button_padpak_cc.ggIsOver=false;
		}
		this._button_padpak_cc.onmousedown=function () {
			me._button_padpak_cc__img.src=basePath + 'geami_sheets_GUI/button_padpak_cc__a.png';
		}
		...
		this._button_fillpak_go__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_fillpak_go.png');
		...
		this._button_fillpak_go.onmouseover=function () {
			me._button_fillpak_go__img.src=basePath + 'geami_sheets_GUI/button_fillpak_go__o.png';
			me._button_fillpak_go.ggIsOver=true;
		}
		this._button_fillpak_go.onmouseout=function () {
			me._button_fillpak_go__img.src=basePath + 'geami_sheets_GUI/button_fillpak_go.png';
			me._button_fillpak_go.ggIsOver=false;
		}
		this._button_fillpak_go.onmousedown=function () {
			me._button_fillpak_go__img.src=basePath + 'geami_sheets_GUI/button_fillpak_go__a.png';
		}
		...
		this._button_fillpak_ttc__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_fillpak_ttc.png');
		...
		this._button_fillpak_ttc.onmouseover=function () {
			me._button_fillpak_ttc__img.src=basePath + 'geami_sheets_GUI/button_fillpak_ttc__o.png';
			me._button_fillpak_ttc.ggIsOver=true;
		}
		this._button_fillpak_ttc.onmouseout=function () {
			me._button_fillpak_ttc__img.src=basePath + 'geami_sheets_GUI/button_fillpak_ttc.png';
			me._button_fillpak_ttc.ggIsOver=false;
		}
		this._button_fillpak_ttc.onmousedown=function () {
			me._button_fillpak_ttc__img.src=basePath + 'geami_sheets_GUI/button_fillpak_ttc__a.png';
		}
		...
		this._button_fillpak_tt__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_fillpak_tt.png');
		...
		this._button_fillpak_tt.onmouseover=function () {
			me._button_fillpak_tt__img.src=basePath + 'geami_sheets_GUI/button_fillpak_tt__o.png';
			me._button_fillpak_tt.ggIsOver=true;
		}
		this._button_fillpak_tt.onmouseout=function () {
			me._button_fillpak_tt__img.src=basePath + 'geami_sheets_GUI/button_fillpak_tt.png';
			me._button_fillpak_tt.ggIsOver=false;
		}
		this._button_fillpak_tt.onmousedown=function () {
			me._button_fillpak_tt__img.src=basePath + 'geami_sheets_GUI/button_fillpak_tt__a.png';
		}
		...
		this._button_fillpak_trident__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_fillpak_trident.png');
		...
		this._button_fillpak_trident.onmouseover=function () {
			me._button_fillpak_trident__img.src=basePath + 'geami_sheets_GUI/button_fillpak_trident__o.png';
			me._button_fillpak_trident.ggIsOver=true;
		}
		this._button_fillpak_trident.onmouseout=function () {
			me._button_fillpak_trident__img.src=basePath + 'geami_sheets_GUI/button_fillpak_trident.png';
			me._button_fillpak_trident.ggIsOver=false;
		}
		this._button_fillpak_trident.onmousedown=function () {
			me._button_fillpak_trident__img.src=basePath + 'geami_sheets_GUI/button_fillpak_trident__a.png';
		}
		...
		this._button_fillpak_m__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_fillpak_m.png');
		...
		this._button_fillpak_m.onmouseover=function () {
			me._button_fillpak_m__img.src=basePath + 'geami_sheets_GUI/button_fillpak_m__o.png';
			me._button_fillpak_m.ggIsOver=true;
		}
		this._button_fillpak_m.onmouseout=function () {
			me._button_fillpak_m__img.src=basePath + 'geami_sheets_GUI/button_fillpak_m.png';
			me._button_fillpak_m.ggIsOver=false;
		}
		this._button_fillpak_m.onmousedown=function () {
			me._button_fillpak_m__img.src=basePath + 'geami_sheets_GUI/button_fillpak_m__a.png';
		}
		...
		this._button_fillpak__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_fillpak.png');
		...
		this._button_fillpak.onmouseover=function () {
			me._button_fillpak__img.src=basePath + 'geami_sheets_GUI/button_fillpak__o.png';
			me._button_fillpak.ggIsOver=true;
		}
		this._button_fillpak.onmouseout=function () {
			me._button_fillpak__img.src=basePath + 'geami_sheets_GUI/button_fillpak.png';
			me._button_fillpak.ggIsOver=false;
		}
		this._button_fillpak.onmousedown=function () {
			me._button_fillpak__img.src=basePath + 'geami_sheets_GUI/button_fillpak__a.png';
		}
		...
		this._button_closed=document.createElement('div');
		this._button_closed.ggId="button_closed";
		this._button_closed.ggParameter={ rx:0,ry:0,a:0,sx:0.25,sy:0.25 };
		this._button_closed.ggVisible=true;
		this._button_closed.className='ggskin ggskin_button';
		this._button_closed.ggType='button';
		this._button_closed.ggUpdatePosition=function() {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-262 + w/2) + 'px';
				var h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-308 + h) + 'px';
			}
		}
		hs ='position:absolute;';
		hs+='left: -262px;';
		...
		hs+='height: 400px;';
		hs+=cssPrefix + 'transform-origin: 50% 50%;';
		hs+=cssPrefix + 'transform: ' + parameterToTransform(this._button_closed.ggParameter) + ';';
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		this._button_closed.setAttribute('style',hs);
		this._button_closed__img=document.createElement('img');
		this._button_closed__img.className='ggskin ggskin_button';
		this._button_closed__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_closed.png');
		this._button_closed__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._button_closed__img.className='ggskin ggskin_button';
		this._button_closed__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._button_closed__img);
		this._button_closed.appendChild(this._button_closed__img);
		this._button_closed.onclick=function () {
			me._button_open_selected.style[domTransition]='none';
			me._button_open_selected.style.visibility='hidden';
			me._button_open_selected.ggVisible=false;
			me._button_closed_selected.style[domTransition]='none';
			me._button_closed_selected.style.visibility='inherit';
			me._button_closed_selected.ggVisible=true;
			me.player.changeViewState("0",0.5);
		}
		this._button_closed.onmouseover=function () {
			me._button_closed__img.src=basePath + 'geami_sheets_GUI/button_closed__o.png';
			me._button_closed.ggIsOver=true;
		}
		this._button_closed.onmouseout=function () {
			me._button_closed__img.src=basePath + 'geami_sheets_GUI/button_closed.png';
			me._button_closed.ggIsOver=false;
		}
		this._button_closed.onmousedown=function () {
			me._button_closed__img.src=basePath + 'geami_sheets_GUI/button_closed__a.png';
		}
		this._button_closed.onmouseup=function () {
			if (me._button_closed.ggIsOver) {
				me._button_closed__img.src=basePath + 'geami_sheets_GUI/button_closed__o.png';
			} else {
				me._button_closed__img.src=basePath + 'geami_sheets_GUI/button_closed.png';
			}
		}
		this._button_closed_selected=document.createElement('div');
		this._button_closed_selected.ggId="button_closed_selected";
		this._button_closed_selected.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._button_closed_selected.ggVisible=true;
		this._button_closed_selected.className='ggskin ggskin_button';
		this._button_closed_selected.ggType='button';
		this._button_closed_selected.ggUpdatePosition=function() {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-200 + w/2) + 'px';
				var h=this.parentNode.offsetHeight;
				this.style.top=Math.floor(-400 + h) + 'px';
			}
		}
		hs ='position:absolute;';
		hs+='left: -200px;';
		...
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		this._button_closed_selected.setAttribute('style',hs);
		this._button_closed_selected__img=document.createElement('img');
		this._button_closed_selected__img.className='ggskin ggskin_button';
		this._button_closed_selected__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_closed_selected.png');
		this._button_closed_selected__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._button_closed_selected__img.className='ggskin ggskin_button';
		this._button_closed_selected__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._button_closed_selected__img);
		this._button_closed_selected.appendChild(this._button_closed_selected__img);
		this._button_closed.appendChild(this._button_closed_selected);
		this.divSkin.appendChild(this._button_closed);
		this._button_open=document.createElement('div');
		this._button_open.ggId="button_open";
		this._button_open.ggParameter={ rx:0,ry:0,a:0,sx:0.25,sy:0.25 };
		this._button_open.ggVisible=true;
		this._button_open.className='ggskin ggskin_button';
		this._button_open.ggType='button';
		this._button_open.ggUpdatePosition=function() {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
		...
		hs+='height: 400px;';
		hs+=cssPrefix + 'transform-origin: 50% 50%;';
		hs+=cssPrefix + 'transform: ' + parameterToTransform(this._button_open.ggParameter) + ';';
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		this._button_open.setAttribute('style',hs);
		this._button_open__img=document.createElement('img');
		this._button_open__img.className='ggskin ggskin_button';
		this._button_open__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_open.png');
		this._button_open__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._button_open__img.className='ggskin ggskin_button';
		this._button_open__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._button_open__img);
		this._button_open.appendChild(this._button_open__img);
		this._button_open.onclick=function () {
			me._button_open_selected.style[domTransition]='none';
			me._button_open_selected.style.visibility='inherit';
			me._button_open_selected.ggVisible=true;
			me._button_closed_selected.style[domTransition]='none';
			me._button_closed_selected.style.visibility='hidden';
			me._button_closed_selected.ggVisible=false;
			me.player.changeViewState("1",0.5);
		}
		this._button_open.onmouseover=function () {
			me._button_open__img.src=basePath + 'geami_sheets_GUI/button_open__o.png';
			me._button_open.ggIsOver=true;
		}
		this._button_open.onmouseout=function () {
			me._button_open__img.src=basePath + 'geami_sheets_GUI/button_open.png';
			me._button_open.ggIsOver=false;
		}
		this._button_open.onmousedown=function () {
			me._button_open__img.src=basePath + 'geami_sheets_GUI/button_open__a.png';
		}
		this._button_open.onmouseup=function () {
			if (me._button_open.ggIsOver) {
				me._button_open__img.src=basePath + 'geami_sheets_GUI/button_open__o.png';
			} else {
				me._button_open__img.src=basePath + 'geami_sheets_GUI/button_open.png';
			}
		}
		this._button_open_selected=document.createElement('div');
		this._button_open_selected.ggId="button_open_selected";
		this._button_open_selected.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._button_open_selected.ggVisible=true;
		this._button_open_selected.className='ggskin ggskin_button';
		this._button_open_selected.ggType='button';
		this._button_open_selected.ggUpdatePosition=function() {
			this.style[domTransition]='none';
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
				this.style.left=Math.floor(-200 + w/2) + 'px';
		...
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		this._button_open_selected.setAttribute('style',hs);
		this._button_open_selected__img=document.createElement('img');
		this._button_open_selected__img.className='ggskin ggskin_button';
		this._button_open_selected__img.setAttribute('src',basePath + 'geami_sheets_GUI/button_open_selected.png');
		this._button_open_selected__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._button_open_selected__img.className='ggskin ggskin_button';
		this._button_open_selected__img['ondragstart']=function() { return false; };
		me.player.checkLoaded.push(this._button_open_selected__img);
		this._button_open_selected.appendChild(this._button_open_selected__img);
		this._button_open.appendChild(this._button_open_selected);
		this.divSkin.appendChild(this._button_open);
		me._img_cat_wrappak.style[domTransition]='none';
		me._img_cat_wrappak.style.visibility='hidden';
		me._img_cat_wrappak.ggVisible=false;
		me._img_cat_padpak.style[domTransition]='none';
