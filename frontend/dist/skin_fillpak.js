...
// Filename: Ranpak_O2VR_Skin_Fillpak.ggsk
// Generated Wed Jul 21 16:17:38 2021
...
function object2vrSkin(player,base) {
	...
	this.preloadImages=function() {
		...
		preLoadImg.src=basePath + 'fillpak_GUI/button_cat_geami__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_cat_geami__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_cat_wrappak__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_cat_wrappak__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_cat_padpak__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_cat_padpak__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_cat_fillpak__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_cat_fillpak__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_ms_cabinet__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_ms_cabinet__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_hv_under_table__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_hv_under_table__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_sheets__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_sheets__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_mx_die_cut_only__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_mx_die_cut_only__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_mx_3d__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_mx_3d__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_hv__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_hv__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_standard__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_standard__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_die_cut_only__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_die_cut_only__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_wrappak_protector__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_wrappak_protector__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_padpak_lc__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_padpak_lc__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_padpak_jr__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_padpak_jr__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_padpak_guardian__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_padpak_guardian__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_padpak_cc__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_padpak_cc__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_go__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_go__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_ttc__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_ttc__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_tt__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_tt__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_trident__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_trident__a.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_m__o.png';
		preLoadImg.src=basePath + 'fillpak_GUI/button_fillpak_m__a.png';
	}
	...
	this.addSkin=function() {
		...
		this._info__img.setAttribute('src',basePath + 'fillpak_GUI/info.png');
		...
		this._logo_01__img.setAttribute('src',basePath + 'fillpak_GUI/logo_01.png');
		...
		this._button_cat_geami__img.setAttribute('src',basePath + 'fillpak_GUI/button_cat_geami.png');
		...
		this._button_cat_geami.onmouseover=function () {
			me._button_cat_geami__img.src=basePath + 'fillpak_GUI/button_cat_geami__o.png';
			me._button_cat_geami.ggIsOver=true;
		}
		this._button_cat_geami.onmouseout=function () {
			me._button_cat_geami__img.src=basePath + 'fillpak_GUI/button_cat_geami.png';
			me._button_cat_geami.ggIsOver=false;
		}
		this._button_cat_geami.onmousedown=function () {
			me._button_cat_geami__img.src=basePath + 'fillpak_GUI/button_cat_geami__a.png';
		}
		...
		this._img_cat_geami__img.setAttribute('src',basePath + 'fillpak_GUI/img_cat_geami.png');
		...
		this._button_cat_wrappak__img.setAttribute('src',basePath + 'fillpak_GUI/button_cat_wrappak.png');
		...
		this._button_cat_wrappak.onmouseover=function () {
			me._button_cat_wrappak__img.src=basePath + 'fillpak_GUI/button_cat_wrappak__o.png';
			me._button_cat_wrappak.ggIsOver=true;
		}
		this._button_cat_wrappak.onmouseout=function () {
			me._button_cat_wrappak__img.src=basePath + 'fillpak_GUI/button_cat_wrappak.png';
			me._button_cat_wrappak.ggIsOver=false;
		}
		this._button_cat_wrappak.onmousedown=function () {
			me._button_cat_wrappak__img.src=basePath + 'fillpak_GUI/button_cat_wrappak__a.png';
		}
		...
		this._img_cat_wrappak__img.setAttribute('src',basePath + 'fillpak_GUI/img_cat_wrappak.png');
		...
		this._button_cat_padpak__img.setAttribute('src',basePath + 'fillpak_GUI/button_cat_padpak.png');
		...
		this._button_cat_padpak.onmouseover=function () {
			me._button_cat_padpak__img.src=basePath + 'fillpak_GUI/button_cat_padpak__o.png';
			me._button_cat_padpak.ggIsOver=true;
		}
		this._button_cat_padpak.onmouseout=function () {
			me._button_cat_padpak__img.src=basePath + 'fillpak_GUI/button_cat_padpak.png';
			me._button_cat_padpak.ggIsOver=false;
		}
		this._button_cat_padpak.onmousedown=function () {
			me._button_cat_padpak__img.src=basePath + 'fillpak_GUI/button_cat_padpak__a.png';
		}
		...
		this._img_cat_padpak__img.setAttribute('src',basePath + 'fillpak_GUI/img_cat_padpak.png');
		...
		this._button_cat_fillpak__img.setAttribute('src',basePath + 'fillpak_GUI/button_cat_fillpak.png');
		...
		this._button_cat_fillpak.onmouseover=function () {
			me._button_cat_fillpak__img.src=basePath + 'fillpak_GUI/button_cat_fillpak__o.png';
			me._button_cat_fillpak.ggIsOver=true;
		}
		this._button_cat_fillpak.onmouseout=function () {
			me._button_cat_fillpak__img.src=basePath + 'fillpak_GUI/button_cat_fillpak.png';
			me._button_cat_fillpak.ggIsOver=false;
		}
		this._button_cat_fillpak.onmousedown=function () {
			me._button_cat_fillpak__img.src=basePath + 'fillpak_GUI/button_cat_fillpak__a.png';
		}
		...
		this._img_cat_fillpak__img.setAttribute('src',basePath + 'fillpak_GUI/img_cat_fillpak.png');
		...
		this._button_geami_ms_cabinet__img.setAttribute('src',basePath + 'fillpak_GUI/button_geami_ms_cabinet.png');
		...
		this._button_geami_ms_cabinet.onmouseover=function () {
			me._button_geami_ms_cabinet__img.src=basePath + 'fillpak_GUI/button_geami_ms_cabinet__o.png';
			me._button_geami_ms_cabinet.ggIsOver=true;
		}
		this._button_geami_ms_cabinet.onmouseout=function () {
			me._button_geami_ms_cabinet__img.src=basePath + 'fillpak_GUI/button_geami_ms_cabinet.png';
			me._button_geami_ms_cabinet.ggIsOver=false;
		}
		this._button_geami_ms_cabinet.onmousedown=function () {
			me._button_geami_ms_cabinet__img.src=basePath + 'fillpak_GUI/button_geami_ms_cabinet__a.png';
		}
		...
		this._button_geami_hv_under_table__img.setAttribute('src',basePath + 'fillpak_GUI/button_geami_hv_under_table.png');
		...
		this._button_geami_hv_under_table.onmouseover=function () {
			me._button_geami_hv_under_table__img.src=basePath + 'fillpak_GUI/button_geami_hv_under_table__o.png';
			me._button_geami_hv_under_table.ggIsOver=true;
		}
		this._button_geami_hv_under_table.onmouseout=function () {
			me._button_geami_hv_under_table__img.src=basePath + 'fillpak_GUI/button_geami_hv_under_table.png';
			me._button_geami_hv_under_table.ggIsOver=false;
		}
		this._button_geami_hv_under_table.onmousedown=function () {
			me._button_geami_hv_under_table__img.src=basePath + 'fillpak_GUI/button_geami_hv_under_table__a.png';
		}
		...
		this._button_geami_sheets__img.setAttribute('src',basePath + 'fillpak_GUI/button_geami_sheets.png');
		...
		this._button_geami_sheets.onmouseover=function () {
			me._button_geami_sheets__img.src=basePath + 'fillpak_GUI/button_geami_sheets__o.png';
			me._button_geami_sheets.ggIsOver=true;
		}
		this._button_geami_sheets.onmouseout=function () {
			me._button_geami_sheets__img.src=basePath + 'fillpak_GUI/button_geami_sheets.png';
			me._button_geami_sheets.ggIsOver=false;
		}
		this._button_geami_sheets.onmousedown=function () {
			me._button_geami_sheets__img.src=basePath + 'fillpak_GUI/button_geami_sheets__a.png';
		}
		...
		this._button_geami_mx_die_cut_only__img.setAttribute('src',basePath + 'fillpak_GUI/button_geami_mx_die_cut_only.png');
		...
		this._button_geami_mx_die_cut_only.onmouseover=function () {
			me._button_geami_mx_die_cut_only__img.src=basePath + 'fillpak_GUI/button_geami_mx_die_cut_only__o.png';
			me._button_geami_mx_die_cut_only.ggIsOver=true;
		}
		this._button_geami_mx_die_cut_only.onmouseout=function () {
			me._button_geami_mx_die_cut_only__img.src=basePath + 'fillpak_GUI/button_geami_mx_die_cut_only.png';
			me._button_geami_mx_die_cut_only.ggIsOver=false;
		}
		this._button_geami_mx_die_cut_only.onmousedown=function () {
			me._button_geami_mx_die_cut_only__img.src=basePath + 'fillpak_GUI/button_geami_mx_die_cut_only__a.png';
		}
		...
		this._button_geami_mx_3d__img.setAttribute('src',basePath + 'fillpak_GUI/button_geami_mx_3d.png');
		...
		this._button_geami_mx_3d.onmouseover=function () {
			me._button_geami_mx_3d__img.src=basePath + 'fillpak_GUI/button_geami_mx_3d__o.png';
			me._button_geami_mx_3d.ggIsOver=true;
		}
		this._button_geami_mx_3d.onmouseout=function () {
			me._button_geami_mx_3d__img.src=basePath + 'fillpak_GUI/button_geami_mx_3d.png';
			me._button_geami_mx_3d.ggIsOver=false;
		}
		this._button_geami_mx_3d.onmousedown=function () {
			me._button_geami_mx_3d__img.src=basePath + 'fillpak_GUI/button_geami_mx_3d__a.png';
		}
		...
		this._button_geami_hv__img.setAttribute('src',basePath + 'fillpak_GUI/button_geami_hv.png');
		...
		this._button_geami_hv.onmouseover=function () {
			me._button_geami_hv__img.src=basePath + 'fillpak_GUI/button_geami_hv__o.png';
			me._button_geami_hv.ggIsOver=true;
		}
		this._button_geami_hv.onmouseout=function () {
			me._button_geami_hv__img.src=basePath + 'fillpak_GUI/button_geami_hv.png';
			me._button_geami_hv.ggIsOver=false;
		}
		this._button_geami_hv.onmousedown=function () {
			me._button_geami_hv__img.src=basePath + 'fillpak_GUI/button_geami_hv__a.png';
		}
		...
		this._button_geami_exbox_mini_standard__img.setAttribute('src',basePath + 'fillpak_GUI/button_geami_exbox_mini_standard.png');
		...
		this._button_geami_exbox_mini_standard.onmouseover=function () {
			me._button_geami_exbox_mini_standard__img.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_standard__o.png';
			me._button_geami_exbox_mini_standard.ggIsOver=true;
		}
		this._button_geami_exbox_mini_standard.onmouseout=function () {
			me._button_geami_exbox_mini_standard__img.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_standard.png';
			me._button_geami_exbox_mini_standard.ggIsOver=false;
		}
		this._button_geami_exbox_mini_standard.onmousedown=function () {
			me._button_geami_exbox_mini_standard__img.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_standard__a.png';
		}
		...
		this._button_geami_exbox_mini_die_cut_only__img.setAttribute('src',basePath + 'fillpak_GUI/button_geami_exbox_mini_die_cut_only.png');
		...
		this._button_geami_exbox_mini_die_cut_only.onmouseover=function () {
			me._button_geami_exbox_mini_die_cut_only__img.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_die_cut_only__o.png';
			me._button_geami_exbox_mini_die_cut_only.ggIsOver=true;
		}
		this._button_geami_exbox_mini_die_cut_only.onmouseout=function () {
			me._button_geami_exbox_mini_die_cut_only__img.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_die_cut_only.png';
			me._button_geami_exbox_mini_die_cut_only.ggIsOver=false;
		}
		this._button_geami_exbox_mini_die_cut_only.onmousedown=function () {
			me._button_geami_exbox_mini_die_cut_only__img.src=basePath + 'fillpak_GUI/button_geami_exbox_mini_die_cut_only__a.png';
		}
		...
		this._button_wrappak_protector__img.setAttribute('src',basePath + 'fillpak_GUI/button_wrappak_protector.png');
		...
		this._button_wrappak_protector.onmouseover=function () {
			me._button_wrappak_protector__img.src=basePath + 'fillpak_GUI/button_wrappak_protector__o.png';
			me._button_wrappak_protector.ggIsOver=true;
		}
		this._button_wrappak_protector.onmouseout=function () {
			me._button_wrappak_protector__img.src=basePath + 'fillpak_GUI/button_wrappak_protector.png';
			me._button_wrappak_protector.ggIsOver=false;
		}
		this._button_wrappak_protector.onmousedown=function () {
			me._button_wrappak_protector__img.src=basePath + 'fillpak_GUI/button_wrappak_protector__a.png';
		}
		...
		this._button_padpak_lc__img.setAttribute('src',basePath + 'fillpak_GUI/button_padpak_lc.png');
		...
		this._button_padpak_lc.onmouseover=function () {
			me._button_padpak_lc__img.src=basePath + 'fillpak_GUI/button_padpak_lc__o.png';
			me._button_padpak_lc.ggIsOver=true;
		}
		this._button_padpak_lc.onmouseout=function () {
			me._button_padpak_lc__img.src=basePath + 'fillpak_GUI/button_padpak_lc.png';
			me._button_padpak_lc.ggIsOver=false;
		}
		this._button_padpak_lc.onmousedown=function () {
			me._button_padpak_lc__img.src=basePath + 'fillpak_GUI/button_padpak_lc__a.png';
		}
		...
		this._button_padpak_jr__img.setAttribute('src',basePath + 'fillpak_GUI/button_padpak_jr.png');
		...
		this._button_padpak_jr.onmouseover=function () {
			me._button_padpak_jr__img.src=basePath + 'fillpak_GUI/button_padpak_jr__o.png';
			me._button_padpak_jr.ggIsOver=true;
		}
		this._button_padpak_jr.onmouseout=function () {
			me._button_padpak_jr__img.src=basePath + 'fillpak_GUI/button_padpak_jr.png';
			me._button_padpak_jr.ggIsOver=false;
		}
		this._button_padpak_jr.onmousedown=function () {
			me._button_padpak_jr__img.src=basePath + 'fillpak_GUI/button_padpak_jr__a.png';
		}
		...
		this._button_padpak_guardian__img.setAttribute('src',basePath + 'fillpak_GUI/button_padpak_guardian.png');
		...
		this._button_padpak_guardian.onmouseover=function () {
			me._button_padpak_guardian__img.src=basePath + 'fillpak_GUI/button_padpak_guardian__o.png';
			me._button_padpak_guardian.ggIsOver=true;
		}
		this._button_padpak_guardian.onmouseout=function () {
			me._button_padpak_guardian__img.src=basePath + 'fillpak_GUI/button_padpak_guardian.png';
			me._button_padpak_guardian.ggIsOver=false;
		}
		this._button_padpak_guardian.onmousedown=function () {
			me._button_padpak_guardian__img.src=basePath + 'fillpak_GUI/button_padpak_guardian__a.png';
		}
		...
		this._button_padpak_cc__img.setAttribute('src',basePath + 'fillpak_GUI/button_padpak_cc.png');
		...
		this._button_padpak_cc.onmouseover=function () {
			me._button_padpak_cc__img.src=basePath + 'fillpak_GUI/button_padpak_cc__o.png';
			me._button_padpak_cc.ggIsOver=true;
		}
		this._button_padpak_cc.onmouseout=function () {
			me._button_padpak_cc__img.src=basePath + 'fillpak_GUI/button_padpak_cc.png';
			me._button_padpak_cc.ggIsOver=false;
		}
		this._button_padpak_cc.onmousedown=function () {
			me._button_padpak_cc__img.src=basePath + 'fillpak_GUI/button_padpak_cc__a.png';
		}
		...
		this._button_fillpak_go__img.setAttribute('src',basePath + 'fillpak_GUI/button_fillpak_go.png');
		...
		this._button_fillpak_go.onmouseover=function () {
			me._button_fillpak_go__img.src=basePath + 'fillpak_GUI/button_fillpak_go__o.png';
			me._button_fillpak_go.ggIsOver=true;
		}
		this._button_fillpak_go.onmouseout=function () {
			me._button_fillpak_go__img.src=basePath + 'fillpak_GUI/button_fillpak_go.png';
			me._button_fillpak_go.ggIsOver=false;
		}
		this._button_fillpak_go.onmousedown=function () {
			me._button_fillpak_go__img.src=basePath + 'fillpak_GUI/button_fillpak_go__a.png';
		}
		...
		this._button_fillpak_ttc__img.setAttribute('src',basePath + 'fillpak_GUI/button_fillpak_ttc.png');
		...
		this._button_fillpak_ttc.onmouseover=function () {
			me._button_fillpak_ttc__img.src=basePath + 'fillpak_GUI/button_fillpak_ttc__o.png';
			me._button_fillpak_ttc.ggIsOver=true;
		}
		this._button_fillpak_ttc.onmouseout=function () {
			me._button_fillpak_ttc__img.src=basePath + 'fillpak_GUI/button_fillpak_ttc.png';
			me._button_fillpak_ttc.ggIsOver=false;
		}
		this._button_fillpak_ttc.onmousedown=function () {
			me._button_fillpak_ttc__img.src=basePath + 'fillpak_GUI/button_fillpak_ttc__a.png';
		}
		...
		this._button_fillpak_tt__img.setAttribute('src',basePath + 'fillpak_GUI/button_fillpak_tt.png');
		...
		this._button_fillpak_tt.onmouseover=function () {
			me._button_fillpak_tt__img.src=basePath + 'fillpak_GUI/button_fillpak_tt__o.png';
			me._button_fillpak_tt.ggIsOver=true;
		}
		this._button_fillpak_tt.onmouseout=function () {
			me._button_fillpak_tt__img.src=basePath + 'fillpak_GUI/button_fillpak_tt.png';
			me._button_fillpak_tt.ggIsOver=false;
		}
		this._button_fillpak_tt.onmousedown=function () {
			me._button_fillpak_tt__img.src=basePath + 'fillpak_GUI/button_fillpak_tt__a.png';
		}
		...
		this._button_fillpak_trident__img.setAttribute('src',basePath + 'fillpak_GUI/button_fillpak_trident.png');
		...
		this._button_fillpak_trident.onmouseover=function () {
			me._button_fillpak_trident__img.src=basePath + 'fillpak_GUI/button_fillpak_trident__o.png';
			me._button_fillpak_trident.ggIsOver=true;
		}
		this._button_fillpak_trident.onmouseout=function () {
			me._button_fillpak_trident__img.src=basePath + 'fillpak_GUI/button_fillpak_trident.png';
			me._button_fillpak_trident.ggIsOver=false;
		}
		this._button_fillpak_trident.onmousedown=function () {
			me._button_fillpak_trident__img.src=basePath + 'fillpak_GUI/button_fillpak_trident__a.png';
		}
		...
		this._button_fillpak_m__img.setAttribute('src',basePath + 'fillpak_GUI/button_fillpak_m.png');
		...
		this._button_fillpak_m.onmouseover=function () {
			me._button_fillpak_m__img.src=basePath + 'fillpak_GUI/button_fillpak_m__o.png';
			me._button_fillpak_m.ggIsOver=true;
		}
		this._button_fillpak_m.onmouseout=function () {
			me._button_fillpak_m__img.src=basePath + 'fillpak_GUI/button_fillpak_m.png';
			me._button_fillpak_m.ggIsOver=false;
		}
		this._button_fillpak_m.onmousedown=function () {
			me._button_fillpak_m__img.src=basePath + 'fillpak_GUI/button_fillpak_m__a.png';
		}
		...
		this._button_fillpak__img.setAttribute('src',basePath + 'fillpak_GUI/button_fillpak.png');
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='leader_economical') {
			this.__div=document.createElement('div');
			this.__div.ggId="leader_economical";
			...
			this.__div.ggUpdatePosition=function() {
				...
				if (this.parentNode) {
					var h=this.parentNode.offsetHeight;
					this.style.top=Math.floor(-492 + h) + 'px';
				}
			}
			hs ='position:absolute;';
			hs+='left: 201px;';
			...
			this._text_economical=document.createElement('div');
			this._text_economical.ggId="text_economical";
			this._text_economical.ggParameter={ rx:0,ry:0,a:0,sx:0.2,sy:0.2 };
			this._text_economical.ggVisible=true;
			this._text_economical.className='ggskin ggskin_image';
			this._text_economical.ggType='image';
			this._text_economical.ggUpdatePosition=function() {
				this.style[domTransition]='none';
				if (this.parentNode) {
					var h=this.parentNode.offsetHeight;
					this.style.top=Math.floor(-448 + h) + 'px';
				}
			}
			hs ='position:absolute;';
			hs+='left: 11px;';
			...
			hs+=cssPrefix + 'transform: ' + parameterToTransform(this._text_economical.ggParameter) + ';';
			hs+='visibility: inherit;';
			this._text_economical.setAttribute('style',hs);
			this._text_economical__img=document.createElement('img');
			this._text_economical__img.className='ggskin ggskin_image';
			this._text_economical__img.setAttribute('src',basePath + 'fillpak_GUI/text_economical.png');
			this._text_economical__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
			this._text_economical__img.className='ggskin ggskin_image';
			this._text_economical__img['ondragstart']=function() { return false; };
			me.player.checkLoaded.push(this._text_economical__img);
			this._text_economical.appendChild(this._text_economical__img);
			this.__div.appendChild(this._text_economical);
		} else
		if (hotspot.skinid=='leader_flexible') {
			this.__div=document.createElement('div');
			this.__div.ggId="leader_flexible";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			this.__div.ggType='hotspot';
			...
			this._text_flexible=document.createElement('div');
			this._text_flexible.ggId="text_flexible";
			this._text_flexible.ggParameter={ rx:0,ry:0,a:0,sx:0.2,sy:0.2 };
			this._text_flexible.ggVisible=true;
			this._text_flexible.className='ggskin ggskin_image';
			this._text_flexible.ggType='image';
			this._text_flexible.ggUpdatePosition=function() {
				this.style[domTransition]='none';
				if (this.parentNode) {
					var h=this.parentNode.offsetHeight;
					this.style.top=Math.floor(-448 + h) + 'px';
			...
			hs+='height: 434px;';
			hs+=cssPrefix + 'transform-origin: 0% 100%;';
			hs+=cssPrefix + 'transform: ' + parameterToTransform(this._text_flexible.ggParameter) + ';';
			hs+='visibility: inherit;';
			this._text_flexible.setAttribute('style',hs);
			this._text_flexible__img=document.createElement('img');
			this._text_flexible__img.className='ggskin ggskin_image';
			this._text_flexible__img.setAttribute('src',basePath + 'fillpak_GUI/text_flexible.png');
			this._text_flexible__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
			this._text_flexible__img.className='ggskin ggskin_image';
			this._text_flexible__img['ondragstart']=function() { return false; };
			me.player.checkLoaded.push(this._text_flexible__img);
			this._text_flexible.appendChild(this._text_flexible__img);
			this.__div.appendChild(this._text_flexible);
		} else
		if (hotspot.skinid=='leader_simple') {
			this.__div=document.createElement('div');
			this.__div.ggId="leader_simple";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			this.__div.ggType='hotspot';
			...
			this._text_simple=document.createElement('div');
			this._text_simple.ggId="text_simple";
			this._text_simple.ggParameter={ rx:0,ry:0,a:0,sx:0.2,sy:0.2 };
			this._text_simple.ggVisible=true;
			this._text_simple.className='ggskin ggskin_image';
			this._text_simple.ggType='image';
			this._text_simple.ggUpdatePosition=function() {
				this.style[domTransition]='none';
				if (this.parentNode) {
					var h=this.parentNode.offsetHeight;
					this.style.top=Math.floor(-448 + h) + 'px';
			...
			hs+='height: 434px;';
			hs+=cssPrefix + 'transform-origin: 0% 100%;';
			hs+=cssPrefix + 'transform: ' + parameterToTransform(this._text_simple.ggParameter) + ';';
			hs+='visibility: inherit;';
			this._text_simple.setAttribute('style',hs);
			this._text_simple__img=document.createElement('img');
			this._text_simple__img.className='ggskin ggskin_image';
			this._text_simple__img.setAttribute('src',basePath + 'fillpak_GUI/text_simple.png');
			this._text_simple__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
			this._text_simple__img.className='ggskin ggskin_image';
			this._text_simple__img['ondragstart']=function() { return false; };
			me.player.checkLoaded.push(this._text_simple__img);
			this._text_simple.appendChild(this._text_simple__img);
			this.__div.appendChild(this._text_simple);
		} else
		{
			this.__div=document.createElement('div');
			this.__div.ggId="leader_compact";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			this.__div.ggType='hotspot';
			...
			this._text_compact=document.createElement('div');
			this._text_compact.ggId="text_compact";
			this._text_compact.ggParameter={ rx:0,ry:0,a:0,sx:0.2,sy:0.2 };
			this._text_compact.ggVisible=true;
			this._text_compact.className='ggskin ggskin_image';
			this._text_compact.ggType='image';
			this._text_compact.ggUpdatePosition=function() {
				this.style[domTransition]='none';
				if (this.parentNode) {
					var h=this.parentNode.offsetHeight;
					this.style.top=Math.floor(-448 + h) + 'px';
			...
			hs+='height: 434px;';
			hs+=cssPrefix + 'transform-origin: 0% 100%;';
			hs+=cssPrefix + 'transform: ' + parameterToTransform(this._text_compact.ggParameter) + ';';
			hs+='visibility: inherit;';
			this._text_compact.setAttribute('style',hs);
			this._text_compact__img=document.createElement('img');
			this._text_compact__img.className='ggskin ggskin_image';
			this._text_compact__img.setAttribute('src',basePath + 'fillpak_GUI/text_compact.png');
			this._text_compact__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
			this._text_compact__img.className='ggskin ggskin_image';
			this._text_compact__img['ondragstart']=function() { return false; };
			me.player.checkLoaded.push(this._text_compact__img);
			this._text_compact.appendChild(this._text_compact__img);
			this.__div.appendChild(this._text_compact);
		}
	};
